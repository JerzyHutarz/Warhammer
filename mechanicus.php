...
$result = $polaczenie->query("SELECT * FROM jednostki WHERE frakcja = 'Mechanicus' ORDER BY $sortColumn $sortOrder");
?>
...
<body>
    ...
    <div class="jednostki-lista">
        <h2>Lista jednostek (Adeptus Mechanicus)</h2>
    ...
    <div class="opis">
      <h2>Czym są Mechanicus w świecie Warhammer 40k?</h2>
      <p>Mechanicus, zwani Adeptus Mechanicus, to kult ludzi wywodzący się z Marsa. Planeta było pierwszą skolonizowną przez ludzi i tam powstał kult "boga maszyny". Techkapłani Marsa są głównymi mechanikami i naukowcami Imperium ludzkości, a sama planeta ma specjalny status. Jest drogą po Ziemi najważniejszą planetą dla ludzkości. Tam też są największe kuźnie i fabryki produkujące maszyny zagłady, które są ciągle potrzebne w nieustannej wojnie jaką ludzie prowadzą z chaosem oraz obcymi rasami.</p>
   </div>
   <div class="image-container">
   <img src="images/admech.jpg" alt="war" class="war-image">
</div>
