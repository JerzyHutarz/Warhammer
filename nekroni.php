...
$result = $polaczenie->query("SELECT * FROM jednostki WHERE frakcja = 'Nekroni' ORDER BY $sortColumn $sortOrder");
?>
...
<body>
    ...
    <div class="opis">
      <h2>Kim są Nekroni świecie Warhammer 40k?</h2>
      <p>Nekroni są jedną z najstarszych ras istniejących w świecie Warhammer 40k. Kiedyś jako rasa byli na skraju zagłady i nie otrzymawszy pomocy rozpętali wielką wojnę zwaną "wojną w niebiosach". W wyniku tej wojny zostali oszukani i przeistoczeni w rasę robotów ze wszczepionymi duszami, nieśmiertelnymi niewolnikami swoich własnych błędów. Po wojnie, która wyniszczyła galaktykę, zapadli w sen, hibernację trwającą miliony lat. W czterdziestym milenium budzą się by przejąć władzę nad galaktyką i odwrócić przemianę, której stali się ofiarami.</p>
   </div>
   <div class="image-container">
   <img src="images/necron.jpg" alt="war" class="war-image">
</div>
