...
$result = $polaczenie->query("SELECT * FROM jednostki WHERE frakcja = 'Eldarzy' ORDER BY $sortColumn $sortOrder");
?>
...
<body>
    ...
    <div class="opis">
      <h2>Kim są Eldarzy w świecie Warhammer 40k?</h2>
      <p>Eldarzy to rasa "kosmicznych elfów". Są jedną ze starszych ras w galaktyce stworzeni kiedyś przez pradawną rasę jako broń do walki z Nekrotyrami, później zwanymi Nekronami. Są rasą wysoce rozwiniętych humanoidów nieznacznie wyższych od ludzi. Posiadają dużą wrażliwość na sztukę, i ta wrażliwość była ich zgubą. Osiągnowszy poziom rozwoju w którym nie musieli pracować poświęcili się rozrywkom i szukaniu uciech ducha. Te poszukiwania z czasem ewoluowały kierując rasę Eldarów w stronę coraz bardziej wyuzdanych i obrzydliwych przyjemności. Ich rozpusta i zamiłowanie do uciech wyzwoliła tak dużo emocji, że ostatecznie doprowadziła do narodzin nowego bożka chaosu, Slaanesh. Narodziny tej istoty stały się początkiem końca Eldarów, ich dusze są ciągle poszukiwane i ścigane przez boga chaosu a jego narodziny wywołały kataklizm który unicestwił większość rasy kosmicznych elfów.</p>
   </div>
   <div class="image-container">
   <img src="images/eldar.jpg" alt="war" class="war-image">
</div>
