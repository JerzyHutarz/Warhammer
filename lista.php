...
// Ustaw domyślne wartości sortowania
$sortColumn = isset($_GET['sort']) ? $_GET['sort'] : 'nazwa_jednostki';
$sortOrder = isset($_GET['order']) ? $_GET['order'] : 'asc';

$dodaneMessage = "";

// Sprawdź, czy istnieje sesja dotycząca dodania jednostki
...
// Pobierz wyniki z bazy danych, sortuj i przechowaj w zmiennych
    ...
    <div class="jednostki-lista">
        ...
        <form action="php/dodaj.php" method="post">
            <table class="table-style">
                <tr>
                    <!-- Nagłówki kolumn tabeli z opcją sortowania -->
